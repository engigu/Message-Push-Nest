...
1. 创建"系统告警"模板
2. 配置自托管消息渠道（同时可配置钉钉/邮件/Telegram 用于即时通知）
3. 系统监控触发告警时发送到自托管渠道
...
2. 配合钉钉/Telegram 等渠道实现即时提醒
3. 所有消息都会存储在 Message Nest 站点
4. 用户登录站点查看历史消息
4. 定期导出归档数据
...
| 特性 | 自托管消息 | 邮件 | 钉钉/企业微信/飞书 | Telegram |
|------|-----------|------|-------------------|----------|
| 实时性 | ⭐⭐⭐ | ⭐⭐ | ⭐⭐⭐⭐⭐ | ⭐⭐⭐⭐⭐ |
| 到达率 | ⭐⭐⭐⭐⭐ | ⭐⭐⭐⭐ | ⭐⭐⭐⭐ | ⭐⭐⭐⭐⭐ |
| 格式支持 | Text/HTML/Markdown | Text/HTML | Text/Markdown | Text/HTML/Markdown |
| 历史查询 | ⭐⭐⭐⭐⭐ | ⭐⭐⭐ | ⭐⭐ | ⭐⭐⭐ |
| 成本 | 免费 | 免费/付费 | 免费 | 免费 |
| 依赖 | 无 | SMTP 服务器 | 对应平台 | Telegram（可能需要代理） |
| 适用场景 | 站内通知、归档 | 正式通知、账单 | 即时通知、协作 | 个人通知、跨国协作 |
...
- **其他渠道** - 推送到外部平台（邮件、钉钉、Telegram 等），用户在对应平台查看
